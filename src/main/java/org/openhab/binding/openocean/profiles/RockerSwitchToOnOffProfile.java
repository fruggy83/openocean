...
import org.openhab.binding.openocean.internal.config.OpenOceanChannelVirtualRockerSwitchConfig.SwitchMode;
...
public class RockerSwitchToOnOffProfile implements TriggerProfile, StateProfile {
    ...
    RockerSwitchToOnOffProfile(ProfileCallback callback, ProfileContext context) {
        ...
        OpenOceanChannelVirtualRockerSwitchConfig config = context.getConfiguration()
                .as(OpenOceanChannelVirtualRockerSwitchConfig.class);
