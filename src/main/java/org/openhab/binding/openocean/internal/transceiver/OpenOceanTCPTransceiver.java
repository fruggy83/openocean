 ...
 */
public class OpenOceanTCPTransceiver extends OpenOceanTransceiver {

    private String host;
    private int port;
    private Socket socket;
    private Logger logger = LoggerFactory.getLogger(OpenOceanTCPTransceiver.class);

    public OpenOceanTCPTransceiver(String host, int port, TransceiverErrorListener errorListener,
    ...
    public void Initialize() throws UnsupportedCommOperationException, NoSuchPortException, PortInUseException,
        ...
        logger.info("OpenOceanTCPTransceiver initialized");
    }
